...
function AboutUs() {
  const values = [
    ...
    },
    {
      icon: Zap,
      title: 'Innovation',
      description: 'Highlighting cutting-edge innovations and breakthroughs in artificial intelligence.'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="flex justify-center mb-6">
            <img
              src={logo}
              alt="TheCloudMind.ai"
              className="h-32 w-32 rounded-full object-cover shadow-2xl ring-4 ring-white/30"
            />
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            About TheCloudMind.ai
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xl text-gray-600 leading-relaxed mb-6">
              ...
              We saw that AI is changing the world fast, and people needed a reliable source
              to stay updated.
            </p>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 md:p-12 text-white text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Stay updated with the latest AI news and insights. Follow us on social media!
          </p>
